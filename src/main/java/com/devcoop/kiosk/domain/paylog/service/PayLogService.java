...
public class PayLogService {
    ...
    @Transactional
    public void savePayLog(String userId, int beforePoint, int pointsUsed, int cardAmount, String paymentId) {
        log.info("결제 로그 저장 시작 - userId: {}, beforePoint: {}, pointsUsed: {}, cardAmount: {}, paymentId: {}", 
                userId, beforePoint, pointsUsed, cardAmount, paymentId);
